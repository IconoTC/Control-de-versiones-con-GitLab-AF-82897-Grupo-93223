...
Investiga qué es un fork en plataformas como GitLab. Después, explica con tus palabras en qué se diferencia un fork de clonar un repositorio. Por último, describe una situación realista en la que un desarrollador preferiría hacer un fork antes que trabajar directamente como colaborador en el repositorio original.
...
Investiga cómo se puede eliminar un repositorio en una plataforma como GitLab. Después, explica qué consecuencias tiene esta acción y qué precauciones tomarías antes de borrar un repositorio remoto en el que ha trabajado más de una persona.
